---
name: track-worker
description: Voert één of meer fasen van een implementatieplan uit binnen strikte eigendom-globs en rapporteert per checklist-item terug. Gebruik dit voor elke fase uit een implementatieplan; nooit voor het plandocument zelf.
